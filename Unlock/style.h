...
{
	// 0xRRGGBBAA
	inline static int BackGroundColor = 0x33353300; //BackGround Color
	inline static int TextColor = 0xFFFFFFFF; //Text Color
	inline static int MainColor = 0xA15FFA00; //Button Color
	inline static int MainAccentColor = 0xaB480FA00; // Other Colors
	inline static int HighlightColor = 0x956BCE00;
...
public:
	...
	static void ApplyTheme()
	{
		...
		colors[ImGuiCol_Border] = Lighten(GetColor(BackGroundColor), 0.10f);
		colors[ImGuiCol_BorderShadow] = GetColor(Black);
		colors[ImGuiCol_FrameBg] = GetColor(MainAccentColor, Alpha90);
		...
		colors[ImGuiCol_TitleBg] = GetColor(BackGroundColor, Alpha60);
		...
		colors[ImGuiCol_NavWindowingDimBg] = GetColor(White, Alpha40);
